...
if(FAIRLOGGER_ROOT)
    set(FAIRLOGGER_DIR "${FAIRLOGGER_ROOT}/include")
    Set(FAIRLOGGER_LIBRARY_DIR "${FAIRLOGGER_ROOT}/lib")
else()
    Message(FATAL_ERROR "FAIRLOGGER path not found")
endif()
...
SET(LD_LIBRARY_PATH  ${HALLIBDIR} ${GSL_LIBRARY_DIR} ${LD_LIBRARY_PATH} ${FAIRLOGGER_LIBRARY_DIR})
