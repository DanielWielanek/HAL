 ...
 */
#include "HalFairAnalysisManager.h"
...
namespace Hal {
  ...
  HalFairAnalysisManager::HalFairAnalysisManager() : fProcessedEvents(0), fManager(nullptr) {
    fManager = new HalFairRootManager();
  }

  InitStatus HalFairAnalysisManager::Init() {
    fManager->Init();
  ...
  void HalFairAnalysisManager::Exec(Option_t* option) {
    ++fProcessedEvents;
  ...
  void HalFairAnalysisManager::Finish() {
  ...
  HalFairAnalysisManager::~HalFairAnalysisManager() {
