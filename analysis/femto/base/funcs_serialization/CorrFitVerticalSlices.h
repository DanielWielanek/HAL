...
namespace Hal {
  ...
  public:
    ...
    void FillNumBufferN(std::complex<double>* shCoord, std::vector<double>& weight, Int_t paramBin);
    void FillDenBufferN(std::complex<double>* shCoord, std::vector<double>& weight, Int_t paramBin);
