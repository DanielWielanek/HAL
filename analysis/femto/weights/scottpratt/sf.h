...
namespace Hal {
  namespace ScottPratt {
    ...
    namespace CoulWave {
      ...
      void GetFGprime(int L, double x, double eta, double* FL, double* GL, double* FLprime, double* GLprime);
      ...
      complex<double> cw2_CWincoming(int ell, complex<double> cx, complex<double> ceta);
      void GetFGprime_ComplexQ(int ell,
                               complex<double> cx,
                               complex<double> ceta,
                               double* FL,
                               double* GL,
                               double* FLprime,
                               double* GLprime);
      void GetFGprime_ImagQ(int ell, double x, double eta, double* FL, double* GL, double* FLprime, double* GLprime);
      void GetFGPrimeArray(int Lmax,
                           double x,
                           double eta,
                           vector<double>& FL,
                           vector<double>& GL,
                           vector<double>& FLprime,
                           vector<double>& GLprime);
      void SphericalCW(int ell, double x, double eta, double* FL, double* GL);
      void SphericalCWprime(int L, double x, double eta, double* FL, double* GL, double* FLprime, double* GLprime);
