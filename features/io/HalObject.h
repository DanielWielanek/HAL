...
public:
   ...
   */
  virtual void
  HTMLExtractIntoTable(Int_t /* no*/, HalHtmlTable& /*table*/, TString /*dir*/ = "", TString /*rel_dir */ = "") const {};
  /**
   * add object of the same class to this
   * @param pack added object
   */
  virtual void Add(const HalObject* pack);
  /**
