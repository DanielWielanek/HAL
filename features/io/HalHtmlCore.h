...
class HalHtmlCore : public TObject {
private:
  static HalHtmlCore* fgInstance;
...
public:
   ...
   */
  static void HTMLExtractIntoTable(TObject* obj, Int_t no, HalHtmlTable& table, TString dir = "", TString rel_dir = "");
  /**
   * TODO
   * @param obj
