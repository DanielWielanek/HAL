 ...
 * method
 */
class HalSpline1D : public TObject {
  TAxis* fXaxis;
  Int_t fNbins;
  Double_t* fA;   //[fNbins]
  Double_t* fB;   //[fNbins]
...
public:
  HalSpline1D(TH1* h = NULL, Double_t begval = 0, Double_t endval = 0);
  /**
 ...
 * method
 */
class HalSpline2D : public TObject {
  TAxis* fXaxis;
  TAxis* fYaxis;
  Int_t fNbinsX;
  Int_t fNbinsY;
  HalArray_3<Double_t> fA;
  HalArray_2<Double_t>* fAe;
...
public:
   ...
   * same as last bin
   */
  HalSpline2D(TH2* h = NULL, Option_t* interpolation = "");
  /**
 ...
 * value of histogram.
 */
class HalSpline3D : public TObject {
  TAxis* fXaxis;
  TAxis* fYaxis;
  TAxis* fZaxis;
  Int_t fNbinsX;
  Int_t fNbinsY;
  Int_t fNbinsZ;
  HalArray_4<Double_t> fA;
  HalArray_3<Double_t> fAe;
...
public:
   ...
   *
   */
  HalSpline3D(TH3* h = NULL, Option_t* interpolation = "");
  /**
