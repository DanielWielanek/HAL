...
class HalChiSqMap2D : public HalObject {
  TH2D* fHist;
  TLine* fLineX;
  TLine* fLineY;
  TLine* fLineXlow;
...
public:
   ...
   */
  HalChiSqMap2D(TString name, Int_t xbins, Double_t xlow, Double_t xhigh, Int_t ybins, Double_t ylow, Double_t yhigh);
  /**
  ...
  virtual ~HalChiSqMap2D();
  ClassDef(HalChiSqMap2D, 1)
};
