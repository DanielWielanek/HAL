...
namespace Hal {
  namespace ScottPratt {
    ...
    const double HBARC_MEV        = 197.3269718;         // hbar times c
    const double HBARC_GEV        = 0.1973269718;        // hbar times c
    ...
    const double ProtonMassGeV    = 0.938272;
    const double KaonMassGeV      = 0.493677;
    const double PionMassGeV      = 0.13957018;
    const double Pion0MassGeV     = 0.1349766;
    const double LambdaMassGeV    = 1.1157;
    const double NeutronMassGeV   = 0.939565;
    const double RhoMassGeV       = 0.7711;
    const double XiMassGeV        = 1.3213;
    const double XiStarMassGeV    = 1.530;
