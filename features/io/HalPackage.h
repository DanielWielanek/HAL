 ...
 */
class HalPackage : public TObject {
...
public:
   ...
   */
  HalPackage(const TObject* object, Bool_t cut_template = kFALSE);
  /**
   ...
   */
  void Add(const HalPackage* pack);
  /**
   ...
   * @return this
   */
  HalPackage& operator+(const HalPackage& rhs);
  virtual ~HalPackage();
  ClassDef(HalPackage, 1)
};
