...
namespace Hal {
   ...
   */
  class FemtoYlmIndexesShort : public TObject {
    Int_t fL;
    Int_t fMaxJM;
    Double_t* fEls;  //[fMaxJM]
    Double_t* fEms;  //[fMaxJM]
  ...
  public:
     ...
     * @param L max L
     */
    FemtoYlmIndexesShort(Int_t L = 5);
    FemtoYlmIndexesShort(const FemtoYlmIndexesShort& other);
    /**
     * assignement operator
     * @param other
     * @return
     */
    FemtoYlmIndexesShort& operator=(const FemtoYlmIndexesShort& other);
    /**
     * changes max L to newL
     * @param newL
     */
     ...
     * destructor
     */
    virtual ~FemtoYlmIndexesShort();
    ClassDef(FemtoYlmIndexesShort, 1)
  };
