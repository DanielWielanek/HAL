 ...
 */
class HalHelixZ : public HalHelixBase {
public:
  HalHelixZ();
  /**
   *
   ...
   */
  HalHelixZ(const TVector3& x, const TVector3& mom, Double_t charge, Double_t conversion = 0.);
  /**
   ...
   * @return
   */
  HalHelixZ& operator=(const HalHelixZ& helix);
  /**
  ...
  virtual ~HalHelixZ() {};
  ClassDef(HalHelixZ, 1)
};

/**
 * helix with non-zero constant Bx  field
 */
class HalHelixX : public HalHelixBase {
public:
  HalHelixX();
  /**
   *
   ...
   * @param conversion not used
   */
  HalHelixX(const TVector3& x, const TVector3& mom, Double_t charge, Double_t conversion = 0.);
  inline void PathLength(Double_t r, Double_t& s1, Double_t& s2) const { BasePathLength(r, s1, s2); }
  /**
   * calculate path lenghts for intersection of helix and circle with center x,y
   * @param r circle radii
   ...
   * @return
   */
  HalHelixX& operator=(const HalHelixX& helix);
  ...
  void Shift(Double_t x, Double_t y, Double_t z);
  virtual ~HalHelixX() {};
  ClassDef(HalHelixX, 1)
};

/**
 * helix with non-zero constant By  field
 */
class HalHelixY : public HalHelixBase {
public:
  HalHelixY();
  /**
   *
   ...
   * @param conversion not used
   */
  HalHelixY(const TVector3& x, const TVector3& mom, Double_t charge, Double_t conversion = 0.);
  inline void PathLength(Double_t r, Double_t& s1, Double_t& s2) const { BasePathLength(r, s1, s2); }
  /**
   * calculate path lenghts for intersection of helix and circle with center x,y
   * @param r circle radii
   ...
   * @return
   */
  HalHelixY& operator=(const HalHelixY& helix);
  void Print(Option_t* /*opt*/ = "") const { BasePrint(); };
  /**
   * shift this helix by given values
   * @param x
  ...
  void Shift(Double_t x, Double_t y, Double_t z);
  virtual ~HalHelixY() {};
  ClassDef(HalHelixY, 1)
};

#ifdef HALHELIX_X
typedef HalHelixX HalHelix;
#else
#ifdef HALHELIX_Y
typedef HalHelixY HalHelix;
#else
typedef HalHelixZ HalHelix;
#endif
#endif
