...
namespace Hal {
  namespace ScottPratt {
    namespace Misc {
      ...
      void outsidelong(FourVector& pa,
                       FourVector& pb,
                       double& qinv,
                       double& qout,
                       double& qside,
                       ...
                       double& dely,
                       double& delphi);
      void outsidelong_lcms(FourVector& pa,
                            FourVector& pb,
                            double& qinv,
                            double& qout,
                            double& qout_lcms,
                            ...
                            double& deleta,
                            double& dely,
                            double& delphi);  // qout_lcms is in lcms frame, not rest frame of pair
      ...
      void
      CubicComplex(double a0, double a1, double a2, double a3, complex<double>& z1, complex<double>& z2, complex<double>& z3);
      void Pause();
