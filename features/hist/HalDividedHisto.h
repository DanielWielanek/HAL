 ...
 * new histogram.
 */
class HalDividedHisto1D : public HalObject {
private:
  /**
...
protected:
   ...
   */
  HalDividedHisto1D(TString name, const Int_t dim);
  /**
...
public:
   ...
   * @param name,
   */
  HalDividedHisto1D(TString name) : HalDividedHisto1D(name, 1) {};
  /**
   * main constructor
   ...
   */
  HalDividedHisto1D(TString name, Int_t nbins, Double_t min, Double_t max, Char_t type = 'D');
  /**
   * copy constructor
   * @param other object to copy
   */
  HalDividedHisto1D(const HalDividedHisto1D& other);
  /**
   * operator =
   * @param other
   * @return
   */
  HalDividedHisto1D& operator=(const HalDividedHisto1D& other);
  /**
   ...
   */
  virtual void Add(const HalObject* h);
  /**
  ...
  virtual ~HalDividedHisto1D();
  ClassDef(HalDividedHisto1D, 4)
};
/**
 * class for storing divided 2-dim histograms
 */
class HalDividedHisto2D : public HalDividedHisto1D {
protected:
  virtual void Normalize(TH1* h) const;
  virtual void SetHistoName(TH1* h) const;
  /**
   ...
   * @param dim
   */
  HalDividedHisto2D(TString name, const Int_t dim) : HalDividedHisto1D(name, dim) {};
  /**
   * return projection
...
public:
   ...
   * @param name
   */
  HalDividedHisto2D(TString name) : HalDividedHisto1D(name, 2) {};
  /**
   * main constructor
   * @param name name of this object
   ...
   */
  HalDividedHisto2D(TString name,
                    Int_t binsX,
                    Double_t minX,
                    Double_t maxX,
                    Int_t binsY,
   ...
   * @param other
   */
  HalDividedHisto2D(const HalDividedHisto2D& other);
  /**
   ...
   * @return
   */
  HalDividedHisto2D& operator=(const HalDividedHisto2D& other);
  ~HalDividedHisto2D();
  ClassDef(HalDividedHisto2D, 2)
};
/**
 * array for storing divided 3-dim histograms
 */
class HalDividedHisto3D : public HalDividedHisto2D {
protected:
...
public:
   ...
   * @param name name
   */
  HalDividedHisto3D(TString name) : HalDividedHisto2D(name, 3) {};
  /**
   *
   * @param name
   * @param binsX
   ...
   */
  HalDividedHisto3D(TString name,
                    Int_t binsX,
                    Double_t minX,
                    Double_t maxX,
                    Int_t binsY,
   ...
   * @param other
   */
  HalDividedHisto3D(const HalDividedHisto3D& other);
  /**
   * fill numerator
   * @param x x - value
   * @param y y - value
   ...
   * @return
   */
  HalDividedHisto3D& operator=(const HalDividedHisto3D& other);
  virtual TString HTMLExtract(Int_t counter = 0, TString dir = " ") const;
  ~HalDividedHisto3D();
  ClassDef(HalDividedHisto3D, 3)
};
